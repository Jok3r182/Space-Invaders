...
import spaceinvaders.resources.objects.aliengrid.grids.PatricksDayGrid;
...
public class PatricksDayLevel extends BaseLevel {
    private int playerPositionY;
    private GameSettings gameSettings;

    public PatricksDayLevel(){
        super(new PatricksDayGrid());
